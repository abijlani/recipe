...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	...
	//AddRecipeController* arc = [[AddRecipeController alloc] initWithNibName:@"AddRecipeController" bundle:nil];
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSString *modelPath = [[NSBundle mainBundle] pathForResource:@"Recipe" ofType:@"momd"];
